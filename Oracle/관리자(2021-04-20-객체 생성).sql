...
-- Oracle에서는 SYSBDA 권한 등급이 있으며
--  일반적인 BDA보다 높은 권한을 갖고 있다
--  SYSBDA 권한은 TableSpace를 만들고, User를 만드는 역할
-- SYS 사용자로 접속한 상태

-- 과제 : DDL SQL 명령을 사용하여 객체 생성
-- 객체 : Oracle TableSpace

-- 1. TableSpace 명 : schoolDB
-- 2. DataFile 명 : C:/oraclexe/data/school.dbf
-- 3. Size : 1MByte, 자동 증가 1KByte 씩
...
-- 자짓 명령을 잘못 입력하고 실행하면 Oracle DBMS 자체에 문제가 생긴다
