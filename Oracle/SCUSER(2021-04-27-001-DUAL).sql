...
SELECT 30 + 40, 30 * 40, 40 - 30, ROUND((40 / 15),2) 
FROM DUAL;
...
SELECT TO_DATE('2021-04-28' || ' 11:20:00','yyyy-mm-dd hh:mi:ss') FROM DUAL;
...
SELECT TO_DATE('2021-04-28:11:27:33','yyyy-mm-dd:hh:mi:ss') FROM DUAL;
