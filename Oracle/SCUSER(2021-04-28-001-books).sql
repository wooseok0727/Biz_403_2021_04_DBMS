...
저자 항목(칼럼)을 보면 저작 2명 이상인 데이터가 있고
...
RENAME COLUMN bk_author TO bk_author1; -- bk_author 칼럼을 bk_author1으로 변경한다

-- bk_author2 라는 칼럼을 생성
-- 한글가변문자열2(50)으로 선언하고 NOT NULL로 설정하라 
...
-- tbl_book_author 에 데이터를 추가하려고 할때
