...
--    주소 : st_addr, 한글 가변문자열 125

CREATE TABLE tbl_student(
        st_num CHAR(5),
        st_name nVARCHAR2(20),
        st_dept nVARCHAR2(10),
        st_grade VARCHAR(5), -- 숫자값을 입력, 숫자값을 문자형으로 인식하게 VARCHAR
        st_tel VARCHAR(20), -- 000-0000-0000
        st_addr nVARCHAR2(125)
);

-- 생성한 Table에 데이터 추가
-- DML(데이터조작어) 명령을 사용하여 데이터를 추가(create)
...
-- 학번칼럼이 NOT NULL되어 있어서 INSERT 불가
